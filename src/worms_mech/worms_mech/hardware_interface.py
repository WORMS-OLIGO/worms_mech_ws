    ...
    def joint_commands_callback(self, msg):
        ...
        for idx, (motor_id, motor_controller) in enumerate(self.motor_controller_dict.items()):
            ...
            if(motor_id == 1 and (abs((self.logical_pos1 - logic_pose_command) < 25))):
                ...
                print("Motor 1 Was Commanded to Move: " + str(logic_pose_command) + " While At Position: " + str(self.logical_pose1))

            elif(motor_id == 2 and (abs((self.logical_pos2 - logic_pose_command) >= 25))):
                print("Motor 2 Was Commanded to Move: " + str(logic_pose_command) + " While At Position: " + str(self.logical_pose1))

            elif(motor_id == 3 and (abs((self.logical_pos3 - logic_pose_command) >= 25))):
                print("Motor 3 Was Commanded to Move: " + str(logic_pose_command) + " While At Position: " + str(self.logical_pose1))
