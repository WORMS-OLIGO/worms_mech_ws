        ...
        for idx, (motor_id, motor_controller) in enumerate(self.motor_controller_dict.items()):
            ...
            if(motor_id == 1):
                ...
                if(abs((self.logical_pos1 - logic_pose_command) < 25)):
                    ...
                    print("Motor 1 Commanded To: " + self.logic_pose_command)
                ...
                if(abs((self.logical_pos2 - logic_pose_command) < 25)):
                    ...
                    print("Motor 2 Commanded To: " + self.logic_pose_command)
                    ...
                    print("Motor 2 Was Commanded to Move: " + str(logic_pose_command) + " While At Position: " + str(self.logical_pos2))
